...
const Experience = () => {
	return (
		<div className="mb-[10%]">
			<h1 className="text-trueface_text text-title font-bold text-center ">
				The Face ID <br />
				...
				{experience.map((exp) => {
					return (
						...
						>
							...
							<h2 className="text-trueface_text font-bold text-[21px]">
								{exp.title}
							</h2>
							<p className="text-subtext text-[14px] font-medium">
								{exp.description}
							</p>
						</div>
					);
